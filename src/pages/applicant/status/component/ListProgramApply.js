...
const ListProgramApply = ({ bloc }) => {
  ...
  return (
    <Box sx={{backgroundColor:'#F2F2F2'}}>
      <Box  sx={{backgroundImage:`url(${header})`, height:'50vh', backgroundSize:'cover', backgroundRepeat:'no-repeat'}} display="flex" justifyContent='center' alignItems='center'>
      <Typography
        textAlign="center"
        sx={{
      ...
      >
        ...
        Number of program applied : {list?.ProgramInfo?.length}
      </Typography>

      </Box> */}
   
      
      {/* {list?.ProgramInfo?.length === 0 ? (
                  ...
                  <Fragment key={idx}>
                    ...
                    >
                      ...
                      >
                        ...
                        <CardActions>
                          <Button
                            sx={{ marginLeft: "20px", marginBottom: "10px", backgroundColor:'#8645FF', color:'white' }}
                            variant="contained"
                            color="secondary"
